...
for test_idx in range(9800, len(ped_dataset)):
    ...
    #     plt.savefig(f"images/all_umlp/{test_idx}.png", bbox_inches='tight', pad_inches=1)
    ...
    #         plt.scatter(*zip(*np.array(ped_dataset[test_idx]["translation"])[6:,:2]), color=blue_colors, s=5, zorder=3)
    #         plt.scatter(*zip(*predictions), color=red_colors, s=5, zorder=4)
    #         plt.savefig(f"images/situation_umlp/{test_idx}.png", bbox_inches='tight', pad_inches=1)
            # plt.show()
    # =============== end of plotting ================
...
# plt.savefig(f"images/hist_umlp/situation_ade.png", bbox_inches='tight', pad_inches=1)
# plt.close()

# plt.hist(fde_values)
# plt.title("Final displacement errors for test samples")
# plt.savefig(f"images/hist_umlp/situation_fde.png", bbox_inches='tight', pad_inches=1)
# plt.close()
